...
function searchRecipe(userIngredients, recipes, searchParameters, diets, allergies) {
    ...
    for (var j = 0; j < searchParameters.length; j++) {
        searchParameters[j] = searchParameters[j] / preferenceTotal * 100
    }
    ...
    for (var k = 0; k < recipes[0].data.length; k++) {
        ...
        for (var m = 0; m < recipes[0].data[k].row[1].length; m++) {
            ...
            if (ingredient[1].weight <= 300) {
                score = score + (searchParameters[1] * ((ingredient[1].weight) / totalRecipeWeight));
                console.log(score);
            }
            ...
            if (matchDiets === true) {
                score = score + (searchParameters[7] * (ingredient[1].weight / totalRecipeWeight));
                console.log(score)
            }
            ...
            for (var n = 0; n < userIngredients.data.length; n++) {
                ...
                if (ingredient[0].name === userIngredient.name && userIngredient.amount >= ingredient[1].amount) {
                    ...
                    score = score + (searchParameters[0] * (ingredient[1].weight / totalRecipeWeight));
                    console.log(score);
            ...
            if (varietyIngredient === true) {
                score = score + (searchParameters[2] * (ingredient[1].weight / totalRecipeWeight));
                console.log(score);
            }
        }
